[requirements.txt](https://github.com/user-attachments/files/26559115/requirements.txt)[streamlit_app.py.py](https://github.com/user-attachments/files/26559112/streamlit_app.py.py)[streamlit_app.py.py](https://github.com/user-attachments/files/26558919/streamlit_app.py.py)# YEBISU-landing[app.py](https://github.com/user-attachments/files/26558650/app.py)
import streamlit as st
import os[save_app.py](https://github.com/user-attachments/files/26559109/save_app.py)import os

# 定义要生成的 Streamlit 代码内容
streamlit_code = """import streamlit as st[Uploading requiremstreamlit
openai
anthropic
python-dotenv
watchdogents.txt…]()

import os[Uploading streamlit_app.py.import streamlit as st
import os[save_app.py](https://github.com/user-attachments/files/26559114/save_app.py)import os
